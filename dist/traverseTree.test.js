...
describe('traverseTree', () => {
    test('root node is a literal', () => {
        ...
        (0, traverseTree_1.traverseTree)('Hello, World!', visitor, null);
    ...
    test('root node is an array', () => {
        const visitor = jest.fn().mockImplementation(state => state);
        (0, traverseTree_1.traverseTree)(['John', 'Paul', 'George', 'Ringo'], visitor, null);
    ...
    test('root node is an object', () => {
        ...
        (0, traverseTree_1.traverseTree)(input, visitor, null);
        expect(visitor).toHaveBeenCalledTimes(5);
        expect(visitor.mock.calls[0][1]).toEqual({
            key: undefined,
            path: [],
    ...
    test('complex object with branch state', () => {
        ...
        (0, traverseTree_1.traverseTree)(input, visitor, { currentMember: null });
    ...
    const array = Array.from({ length: 1000000 }, (_, i) => leaf(i));
    test('root node is an array with 1 million rows', () => {
        const visitor = jest.fn().mockImplementation(state => state);
        (0, traverseTree_1.traverseTree)(array, visitor, null);
